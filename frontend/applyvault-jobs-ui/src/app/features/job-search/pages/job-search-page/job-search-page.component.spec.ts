...
describe('JobSearchPageComponent', () => {
  ...
  function flushEuresBootstrap(searchResponse = createEuresSearchResponse()) {
  ...
  function flushEuresFollowUpSearch(
    ...
    httpMock
      ...
      .forEach((request) =>
        request.flush(createEuresJobDetail({ id: 'eures-2', title: 'Frontend Developer' }))
      );
  }
  ...
  it('runs a new EURES search when keywords are submitted', () => {
    fixture.detectChanges();
    flushEuresBootstrap();
    fixture.detectChanges();
